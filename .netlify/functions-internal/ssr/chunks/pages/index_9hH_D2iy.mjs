...
const $$Button = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(href, "href")} target="_blank"${addAttribute(`${active ? "text-white bg-gray-900 md:inline-block hover:bg-gray-900/5" : "text-black bg-white hover:bg-white/60"} md:text-md text-sm px-10 py-3 rounded-full`, "class")}>${title}</a>`;
...
const $$About = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$About;
  return renderTemplate`${maybeRenderHead()}<div class="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-10 max-w-5xl mx-auto items-center my-10 md:my-[100px]"> <figure class="md:max-w-sm"> <img src="/ange.jpeg" alt="ange" class="ange"> </figure> <div class="justify-start"> <div class="text-white leading-none"> <h2 class="text-2xl lg:text-4xl font-medium">
a brief
<span class="text-4xl lg:text-5xl font-display font-light">discovery</span>
on me.
</h2> <p class="my-5 text-p lg:text-lg leading-tight  pb-2 lg:pb-10">We believe that the human dimensions essential to start any successful project and that this is where splendid emotional relationships between the company and people are born.
<br> <br>
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en"> <head>${renderComponent($$result, "MainHead", $$MainHead, { "title": title })}${renderHead()}</head> <body> <div class="wrapper"> ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "Footer", $$Footer, {})} </div> </body></html>`;
